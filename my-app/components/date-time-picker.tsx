...
export default function DateTimePicker({ value, onChange, mode = 'datetime' }: DateTimePickerProps) {
  ...
  // PickerColumn component to properly use React hooks
  const PickerColumn = ({
    items,
    selectedValue,
    onValueChange,
    ...
    return (
      <View style={styles.container}>
        <PickerColumn
          ...
          onValueChange={(value: number) => handleDateChange('year', value)}
        ...
        <PickerColumn
          ...
          onValueChange={(value: number) => handleDateChange('month', value)}
          formatter={(value: number) => value.toString().padStart(2, '0')}
        />
        <PickerColumn
          items={days}
          selectedValue={selectedDate.getDate()}
          onValueChange={(value: number) => handleDateChange('day', value)}
          formatter={(value: number) => value.toString().padStart(2, '0')}
        />
      </View>
    );
    ...
    return (
      <View style={styles.container}>
        ...
        <PickerColumn
          ...
          onValueChange={(value: number) => handleDateChange('minute', value)}
        />
      </View>
    );
  }
